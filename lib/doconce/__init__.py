...
.. Those files are too comprehensive for a doc string.
...
text constructions that allow you to control the formating. For example,
  ...
  * tables, figures, movies with captions, URLs with links, index list, labels and references are supported,
...
Documentation of DocOnce is found in
  ...
  * The tutorial in ``doc/tutorial/tutorial.do.txt`` (file paths are here given relative to the root of the DocOnce source code).

  * The more comprehensive documentation in ``doc/manual/manual.do.txt``.

  * There is web access to the `tutorial <https://doconce.github.io/doconce/doc/pub/tutorial/html/tutorial.html>`__ the `manual <https://doconce.github.io/doconce/doc/pub/manual/html/manual.html>`__

...
Documentation of DocOnce is found in
  ...
  * There is web access to the tutorial (https://doconce.github.io/doconce/doc/pub/tutorial/html/tutorial.html) the manual (https://doconce.github.io/doconce/doc/pub/manual/html/manual.html)

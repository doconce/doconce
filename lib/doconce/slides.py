...
def _usage_slides_html():
    print('Usage:\n'
          'doconce slides_html mydoc.html (reveal | deck | csss | dzslides)\n'
          '--html_slide_theme=theme --html_slide_transition=theme --html_footer_logo=name\n'
          '--nav_button=name --font_size=slides --copyright=everypage|titlepage --output=fileout\n'
          '\n'
          ...
          '  the title page only.\n'
          '--output=fileout give the output filename or file basename\n'
          '\n'
          'Notes:\n'
...
def slides_html():
    ...
    if filestr is not None:
        ...
        f.write(filestr)
        f.close()
        print('slides written to ' + fileout)

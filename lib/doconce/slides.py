...
def _usage_slides_html():
    msg = ('\nUsage: doconce slides_html mydoc.html <slide_type> --html_slide_theme=theme\n'
           ...
           '  note: reveal and deck slide styles are doconce variants, different from the original styles.\n'
           ...
           '\n'
           '--html_slide_transition=theme sets the theme for the deck.js slides listed'
           '  in the deck.js-latest.zip package data:\n'
           '  horizontal-slide, vertical-slide, fade. Default: none\n'
           '\n'
...
def generate_html5_slides(header, parts, footer, basename, filename, slide_tp='reveal'):
    ...
    if transition:
        ...
        slide_syntax[slide_tp]['transition'] = os.path.join(deck_folder,
                                                            os.path.join("themes/transition",
                                                                         transition + ".css"))
...
def _usage_slides_beamer():
    msg = ('Usage: doconce slides_beamer mydoc --beamer_slide_theme=theme_name --beamer_slide_navigation=off '
